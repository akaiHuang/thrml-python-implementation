...
THRML Python Implementation is a pure Python and NumPy port of the Thermodynamic Hypergraphical Model Library. It provides a lightweight environment for experimentation, teaching, and model validation.
